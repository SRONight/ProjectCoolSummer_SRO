...
<head>
<meta charset="UTF-8">
<title>여기는 안쓰는 페이지 입니다! 대신 백업용으로 안 없앴어요~</title>
<script type="text/javascript" src="resources/jQuery.js"></script>
<script type="text/javascript" src="resources/js/jQueryFunction.js"></script>
		...
		<tr>
			<c:forEach var="r" items="${restplaces }">
				<tr class="namerow">
					...
					<td>${r.chk2_yn }</td>
					<td>${r.chk3_yn }</td>
					<td align="center"><a id="mapopenBtn"><img src="resources/img/downmenu24px.png"></a></td>
				</tr>
				<tr class="maprow"><td colspan='11'><div id="map" style="width:100%;height:350px;display:none"></div></td></tr>
			</c:forEach>
		</tr>
	</table>
</body>
